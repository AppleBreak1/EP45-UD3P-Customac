# macOS Mojave Installer
  ...
  - [Install Security Update 2021-005](https://support.apple.com/kb/DL2078?locale=en_US) (18G9323)
...
SMBIOS -> iMacPro1,1 (Selected for installation and update purpose; any Mac models supported in Mojave will actually work)
...
EVGA GeForce GTX 770 hardware acceleration (Natively supported in Mojave)
...
- Making macOS Mojave USB Installer

  - Copy "Install macOS Mojave.app" to Application folder
...
- For Mojave or older, systems may notify "Disk Not Ejected Properly" warning on wake when USB disks are connected to the system. To resolve this issue you may use [Fix-usb-sleep](https://github.com/syscl/Fix-usb-sleep). However, this is no longer an issue in Catalina+ for this build.
